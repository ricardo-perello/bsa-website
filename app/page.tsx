...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl md:text-4xl font-bold mb-6">About BSA</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Regular workshops on blockchain technology and development</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="bg-[#1f273a] text-white p-2 rounded-full mt-1">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      />
                      <path
                        d="M16 3.13C17.7105 3.58317 19.0053 5.17798 19.0053 7.005C19.0053 8.83202 17.7105 10.4268 16 10.88"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">Hackathons & Projects</h4>
                    <p className="text-gray-600">Hands-on experience building blockchain applications</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      {/* Join Us Section */}
      <section id="join" className="py-16 bg-[#1f273a] text-white">
