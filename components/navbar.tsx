        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              ...
              <span className="text-2xl font-bold tracking-tight">BSA</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/articles" className="text-gray-700 hover:text-black transition-colors">
              Articles
            </Link>
            <Link href="/startups" className="text-gray-700 hover:text-black transition-colors">
              Startups
            </Link>
            <Link href="/team" className="text-gray-700 hover:text-black transition-colors">
              Team
            </Link>
